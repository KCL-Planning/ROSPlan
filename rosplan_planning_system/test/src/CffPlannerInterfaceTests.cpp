...
GTEST_TEST(PlannerInterfaceTests, Test1_plan_found) {
    ...
    srv.request.planner_command = "timeout 10 " + rosplan_planning_system_path + "/common/bin/Contingent-FF -o DOMAIN -f PROBLEM";
...
GTEST_TEST(PlannerInterfaceTests, Test2_format_published_on_planner_output) {
    ...
    std::string known_plan = "0: (movetob ball)  [0.001]\n";
...
int main(int argc, char **argv) {
    ...
    ros::init(argc, argv, "CffPlannerInterfaceTests");
