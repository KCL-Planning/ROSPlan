...
GTEST_TEST(PlannerInterfaceTests, Test1_plan_found) {
    ...
    srv.request.planner_command = "timeout 10 " + chimp_path + "/gradlew run -p " + chimp_path + " -Dexec.args=\"DOMAIN PROBLEM\"";
...
// GTEST_TEST(PlannerInterfaceTests, Disable_Test2_format_published_on_planner_output) {
