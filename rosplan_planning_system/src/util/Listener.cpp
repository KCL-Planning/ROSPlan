...
#include "rosplan_dispatch_msgs/ActionFeedback.h"
	...
	void testDisptachCallback(const rosplan_dispatch_msgs::ActionDispatch::ConstPtr& msg)
	{
	...
	void testFeedbackCallback(const rosplan_dispatch_msgs::ActionFeedback::ConstPtr& msg)
	{
