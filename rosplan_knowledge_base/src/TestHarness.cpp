...
bool getInstanceAttr(rosplan_knowledge_msgs::AttributeService::Request  &req, rosplan_knowledge_msgs::AttributeService::Response &res)
{
	...
	if(req.type_name.compare("gripper")==0) {
		...
		attr.knowledge_type = rosplan_knowledge_msgs::KnowledgeItem::INSTANCE_ATTRIBUTE;
...
bool getDomainAttr(rosplan_knowledge_msgs::AttributeService::Request  &req, rosplan_knowledge_msgs::AttributeService::Response &res)
{
	...
	if(req.predicate_name.compare("empty")==0) {
		rosplan_knowledge_msgs::KnowledgeItem attr;
		attr.knowledge_type = rosplan_knowledge_msgs::KnowledgeItem::DOMAIN_ATTRIBUTE;
		attr.instance_type = "";
		attr.instance_name = "";
...
bool getCurrentGoals(rosplan_knowledge_msgs::AttributeService::Request  &req, rosplan_knowledge_msgs::AttributeService::Response &res)
{
	...
	if(req.instance_name.compare("b1")==0) {
		...
		{ // predicate attributes
			rosplan_knowledge_msgs::KnowledgeItem attr_on1;
			attr_on1.knowledge_type = rosplan_knowledge_msgs::KnowledgeItem::DOMAIN_ATTRIBUTE;
